defmodule DemoWeb.Router do
  ...
  # Health/probe endpoints. No session, no CSRF, no LiveView — kept deliberately
  # cheap so Kubernetes liveness/readiness/startup probes add negligible load.
  scope "/healthz", DemoWeb do
